...
const FeatureSection = ({ 
  ...
  return (
    <section 
      id={id} 
      ref={sectionRef}
      className="py-20 md:py-28 opacity-0 transition-opacity duration-1000 ease-out"
    >
    ...
    <>
          ...
          {[
            {
              ...
              cta: "Perfect for bootstrapped projects"
            },
            {
              title: "Indie Hackers",
      ...
      <div className="bg-blue-50/50">
        <FeatureSection
          ...
          icon={Code}
          title="The Problem"
          description="Current AI tools are powerful but disjointed, making it hard to build complete products."
        >
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="glass-card rounded-xl p-6 bg-white/90">
              <div className="rounded-lg bg-gray-800 p-4 text-white text-sm font-mono overflow-hidden">
                <p className="text-green-400">$ ai build my social network</p>
                <p className="text-gray-400 mt-2">// Generated code snippet:</p>
                <p className="text-white mt-1">function createUser(name, email) &#123;</p>
                <p className="text-white ml-4">// TODO: Implement database</p>
                <p className="text-white ml-4">return &#123; id: 1, name, email &#125;;</p>
                <p className="text-white">&#125;</p>
                <p className="text-red-400 mt-2">Error: This is just one function. What about the rest of the app?</p>
              </div>
            </div>
          </div>
        </FeatureSection>
