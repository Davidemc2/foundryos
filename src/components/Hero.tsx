...
const Hero = () => {
  return (
    <section className="pt-32 pb-20 md:pt-40 md:pb-32 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 -z-10 h-[500px] w-[500px] rounded-full bg-violet-100/20 blur-[100px]" />
      
      <div className="container-custom relative">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          <span className="inline-flex items-center px-3 py-1 text-xs font-medium rounded-full bg-violet-50 text-violet-700 mb-8 opacity-0 animate-fadeIn animation-delay-200">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center opacity-0 animate-fadeIn animation-delay-800">
            <a 
              href="#early-access" 
              className="w-full sm:w-auto px-6 py-3 rounded-full bg-violet-700 text-white font-medium hover:bg-violet-800 transition-all flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transform hover:-translate-y-1 text-lg"
            >
        ...
        <div className="relative mt-16 md:mt-24 opacity-0 animate-slideUp animation-delay-800">
            ...
            <div className="bg-white rounded-xl overflow-hidden p-6">
              <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-8">
                <div className="flex-1 flex flex-col items-center text-center md:text-left md:items-start">
                  <div className="bg-violet-100 text-violet-700 w-10 h-10 rounded-full flex items-center justify-center mb-3">1</div>
          ...
          <div className="absolute -bottom-6 -right-6 -z-10 h-[300px] w-[300px] rounded-full bg-violet-100/30 blur-[100px]" />
        </div>
      </div>
    </section>
  );
